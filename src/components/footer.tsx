  ...
  return (
    <footer className="mt-auto border-t border-border bg-background-alt">
      <div className="mx-auto max-w-6xl px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        {/* Brand */}
        <div>
          <p className="font-display text-xl font-semibold mb-3">Portugala</p>
          <p className="text-sm text-foreground-muted leading-relaxed max-w-xs">
            Hand-picked private villas in the Algarve, personally arranged by
            our team in London and Portugal.
          </p>
        </div>

        {/* Navigation */}
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.1em] text-foreground-muted mb-4">
            Navigate
          </p>
