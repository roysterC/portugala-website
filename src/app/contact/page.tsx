...
export const metadata: Metadata = {
  title: 'Contact',
  description:
    'Get in touch with Portugala — our London office is ready to help you find the perfect Algarve villa.',
};
        ...
        <FadeIn>
          <div>
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-[1.05]">
              Let&rsquo;s plan your Algarve holiday
            </h1>
            <p className="text-foreground-muted text-lg leading-relaxed mb-12">
              Know what you want or need help choosing? Either way — call, email,
              or send us a message and we will get back to you promptly.
            </p>

            <div className="space-y-6">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.12em] text-foreground-muted mb-1.5 font-mono">
                  Email
                </p>
                <a
